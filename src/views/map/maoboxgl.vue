...
export default {
  data(){
    return{
      MyToken:'pk.eyJ1IjoiemFyZHNoeSIsImEiOiJjand1YXU1aTAwOTUyNDlscnNjdTZ6ZHR1In0.pVt9-AoZhnXF5mR78xSm0g',
      CNLFurl:'https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-rtl-text/v0.1.0/mapbox-gl-rtl-text.js',
      Map:null,
      mk_id:'mk01',
      Marker_geojson:{
                "id": 'mk01',
