...
export default {
  ...
  methods:{
    add3Dmarker(){
      ...
      let markers=[];
      let mk=[
        [121.1,31.1331,10001],[121.12234,31.133,8001],[121.1342,31.13241,6001],[121.14,31.1123,7001],
        [121.4,31.223,10001],[121.2234,31.133,8001],[121.13,31.12341,6001],[121.14,31.1423,700]
        ];
      for(let i of mk){
        markers.push(new maptalks.Marker([i[0],i[1]], {
              properties : {
                altitude :  i[2]
              }
        }))
